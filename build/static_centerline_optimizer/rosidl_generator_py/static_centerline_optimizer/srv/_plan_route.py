...
class PlanRoute_Request(metaclass=Metaclass_PlanRoute_Request):
    ...
    def start_lane_id(self, value):
        if __debug__:
            ...
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'start_lane_id' field must be an integer in [-9223372036854775808, 9223372036854775807]"
    ...
    def end_lane_id(self, value):
        if __debug__:
            ...
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'end_lane_id' field must be an integer in [-9223372036854775808, 9223372036854775807]"
