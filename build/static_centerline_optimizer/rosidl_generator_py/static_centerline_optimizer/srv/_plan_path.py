...
class PlanPath_Request(metaclass=Metaclass_PlanPath_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.route = array.array('q', kwargs.get('route', []))
    ...
    def route(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'q', \
                "The 'route' array.array() must have the type code of 'q'"
            self._route = value
            return
        if __debug__:
            ...
            assert \
                ...
                "The 'route' field must be a set or sequence and each value of type 'int' and each integer in [-9223372036854775808, 9223372036854775807]"
        self._route = array.array('q', value)
...
class PlanPath_Response(metaclass=Metaclass_PlanPath_Response):
    ...
    _fields_and_field_types = {
        ...
        'message': 'string',
        'unconnected_lane_ids': 'sequence<int64>',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.unconnected_lane_ids = array.array('q', kwargs.get('unconnected_lane_ids', []))
    ...
    def unconnected_lane_ids(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'q', \
                "The 'unconnected_lane_ids' array.array() must have the type code of 'q'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, int) for v in value) and
                 all(val >= -9223372036854775808 and val < 9223372036854775808 for val in value)), \
                "The 'unconnected_lane_ids' field must be a set or sequence and each value of type 'int' and each integer in [-9223372036854775808, 9223372036854775807]"
        self._unconnected_lane_ids = array.array('q', value)
