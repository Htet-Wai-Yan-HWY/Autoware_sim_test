...
#define NODE_MAIN_LOGGER_NAME "robosense_driver_ros_wrapper_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "librobosense_driver_ros_wrapper.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<RobosenseDriverRosWrapper>";
