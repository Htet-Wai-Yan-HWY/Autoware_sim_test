...
#define NODE_MAIN_LOGGER_NAME "duplicated_node_checker_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libduplicated_node_checker.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<duplicated_node_checker::DuplicatedNodeChecker>";
