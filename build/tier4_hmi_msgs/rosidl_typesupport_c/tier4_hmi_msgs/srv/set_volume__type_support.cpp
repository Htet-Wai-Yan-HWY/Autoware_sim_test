...
static const _SetVolume_Request_type_support_symbol_names_t _SetVolume_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tier4_hmi_msgs, srv, SetVolume_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tier4_hmi_msgs, srv, SetVolume_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tier4_hmi_msgs, srv, SetVolume_Request)() {
  return &::tier4_hmi_msgs::srv::rosidl_typesupport_c::SetVolume_Request_message_type_support_handle;
}
...
static const _SetVolume_Response_type_support_symbol_names_t _SetVolume_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tier4_hmi_msgs, srv, SetVolume_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tier4_hmi_msgs, srv, SetVolume_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tier4_hmi_msgs, srv, SetVolume_Response)() {
  return &::tier4_hmi_msgs::srv::rosidl_typesupport_c::SetVolume_Response_message_type_support_handle;
}
...
static const _SetVolume_type_support_symbol_names_t _SetVolume_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tier4_hmi_msgs, srv, SetVolume)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tier4_hmi_msgs, srv, SetVolume)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, tier4_hmi_msgs, srv, SetVolume)() {
  return &::tier4_hmi_msgs::srv::rosidl_typesupport_c::SetVolume_service_type_support_handle;
}
