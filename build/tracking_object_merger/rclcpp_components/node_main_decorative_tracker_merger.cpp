...
#define NODE_MAIN_LOGGER_NAME "decorative_tracker_merger"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libdecorative_tracker_merger_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<tracking_object_merger::DecorativeTrackerMergerNode>";
