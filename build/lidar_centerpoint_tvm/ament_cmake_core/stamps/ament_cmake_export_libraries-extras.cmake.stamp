...
set(_exported_libraries "lidar_centerpoint_tvm;lidar_centerpoint_tvm_component;single_inference_lidar_centerpoint_tvm_component")
  ...
  while(_i LESS _length)
    ...
    if(NOT _library_dirs)
      ...
      if(NOT _lib)
        # warn about not existing library and later ignore it
        message(WARNING
          "Package 'lidar_centerpoint_tvm' exports library '${_library_name}' with LIBRARY_DIRS '${_library_dirs}' which couldn't be found")
      endif()
    endif()
    if(_lib)
      list(APPEND lidar_centerpoint_tvm_LIBRARIES ${_cfg} "${_lib}")
