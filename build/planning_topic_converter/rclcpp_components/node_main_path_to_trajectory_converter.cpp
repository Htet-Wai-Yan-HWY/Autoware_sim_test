...
#define NODE_MAIN_LOGGER_NAME "path_to_trajectory_converter"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libplanning_topic_converter.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<planning_topic_converter::PathToTrajectory>";
