...
#define NODE_MAIN_LOGGER_NAME "predicted_path_checker_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpredicted_path_checker.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<autoware::motion::control::predicted_path_checker::PredictedPathCheckerNode>";
